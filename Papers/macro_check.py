...
macros = {}
if os.path.isfile(os.environ['HOME']+'/astro/software/Astronomy/Papers/privon_astro.sty'):
    sty = open(os.environ['HOME']+'/astro/software/Astronomy/Papers/privon_astro.sty','r')
    for line in sty:
...
sys.stdout.write('Finished searching '+texfile+'. Please copy the following macros into your manuscript: \n\n')
